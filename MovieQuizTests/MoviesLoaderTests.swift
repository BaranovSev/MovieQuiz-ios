...
private struct StubNetworkingClient: NetworkRouting {
...
class MoviesLoaderTests: XCTestCase {
    func testSuccessLoading() throws {
        //Given
        let stubNetworkClient = StubNetworkingClient(emulateError: false)
    ...
    func testFailureLoading() throws {
        //Given
        let stubNetworkClient = StubNetworkingClient(emulateError: true)
        let loader = MoviesLoader(networkClient: stubNetworkClient)
